  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen fixed left-0 top-0 z-50">
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-800">
        ...
        <span className="font-bold text-white tracking-tight">Neptune<span className="text-slate-500">OS</span></span>
      </div>
      ...
      <div className="p-4 border-t border-slate-800">
        <button className="flex items-center gap-3 w-full px-4 py-3 text-slate-400 hover:text-white hover:bg-slate-800 rounded-lg transition-colors text-sm font-medium">
            <Settings size={20} />
            Settings
        </button>
        <button 
